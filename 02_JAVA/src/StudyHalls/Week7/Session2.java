...
//    Write a program that can concate two arrays
        ...
        int [] arrayAnswer=new int[array1.length + array2.length];// 9
 ...
 makeLines();
     ...
     int a=   calculateAge2(2000); //return  2022-2000;
        System.out.println(a);

      int age2=calculateAge2(1990);
        System.out.println("age2 = " + age2);
        System.out.println(calculateAge2(1980));// return 2022-1980
